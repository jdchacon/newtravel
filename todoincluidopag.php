...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Paquetes todo incluido - Viajeo | Tu agencia de viajes</title>
		<meta name="description" content="Paquetes Todo Incluido...
...
function sort(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","todoincluidoajax.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
	...
	$(window).load(function(){
		...
		<body id="category" class="category category-39 category-paquetes-todo-incluido hide-right-column lang_es  two-columns">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<span class="navigation_page">Paquetes todo incluido</span>
			</div>
...
<!-- /MODULE Block new products --></div>
                    ...
                    <div class="content_scene_cat_bg row">
                        	...
                        	<img class="img-responsive" src="img/c/39-tm_home_default.jpg" alt="Paquetes todo incluido" />
                        </div>
                                                                            <div class="cat_desc  col-xs-12 col-sm-7 col-md-8 col-lg-9">
                            <span class="category-name">
                                Paquetes todo incluido                            </span>
                                                            <div class="rte"><h2><span style="color:rgb(1,61,123);">Paquetes Todo Incluido...</span></h2>
<p><span style="color:rgb(1,61,123);">Despreocúpate con nuestros paquetes todo incluido, aquí solo importa disfrutar.</span></p></div>
                                                        </div>
                                             </div>
                              </div>
				<h1 class="page-heading product-listing">
        	<span class="cat-name">Paquetes todo incluido&nbsp;</span>
            <span class="heading-counter"><?php
             $q = intval($_GET['varname']);
 $off = ($q-1)*9;
 $off9 = $off +9;
...
$sqle = "SELECT COUNT(idproducto) AS hay FROM productos WHERE paquete = '1'";
...
?></span>
        ...
        <li id="grid">
            <a rel="nofollow" href="index.php%3Fid_category=39&amp;controller=category.html#" title="Cuadr&iacute;cula">
                <i class="fa fa-th-large"></i>
                Cuadr&iacute;cula
            </a>
        </li>
        <li id="list">
            <a rel="nofollow" href="index.php%3Fid_category=39&amp;controller=category.html#" title="Lista">
	...
	<div id="pagination" class="pagination clearfix">
	    			<form class="showall" action="index.php%3Fid_category=39&amp;controller=category.html" method="get">
				<div>
...
?> 
<li>
							<a  href="novedadespag.php?varname=<?php echo $x ?>">
								<span><?php  
echo $x;
?> </span>
							</a>
...
?>  
    ...
    <div class="product-count">
    	    		                        	                        	Mostrando <?php echo $off?> - <?php echo $off9 ?> de  <?php echo $cantidad?> productos
	<!-- /Pagination -->
...
$sql = "SELECT * FROM productos WHERE paquete = '1' LIMIT 9 OFFSET $off";
                        ...
                        <div class="product-image-container">
                            <a >
                                ...
                                <span></span>
                                                                                        ...
                                                                                        <a class="new-box" href="index.php%3Fid_product=26&amp;controller=product.html">
...
<section class="blockcategories_footer footer-block col-xs-12 col-sm-2">
	...
	<a 	href="index.php%3Fid_category=39&amp;controller=category.html" class="selected" title="Paquetes Todo Incluido...  
  Despreocúpate con nuestros paquetes todo incluido, aquí solo importa disfrutar.">
