...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Nacionales - Viajeo | Tu agencia de viajes</title>
		<meta name="description" content="Estos son algunos de nuestros destinos nacionales:" />
...
function sort(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","dnacionalajax.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
	...
	$(window).load(function(){
		...
		<body id="category" class="category category-51 category-nacionales hide-right-column lang_es  two-columns">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<a href="index.php%3Fid_category=53&amp;controller=category.html" title="Destinos" data-gg="">Destinos</a><span class="navigation-pipe">></span>Nacionales
			</div>
...
<li >
	<a 	href="cdm.php" title="">
		Ciudad de México
	</a>
	</li>
	<li >
	<a 	href="guadalajara.php" title="">
		Guadalajara
	</a>
	</li>
	<li >
	<a 	href="monterrey.php" title="">
		Monterrey
	</a>
	</li>
...
<!-- /MODULE Block new products --></div>
                    ...
                    <div class="content_scene_cat_bg row">
                        	...
                        	<img class="img-responsive" src="img/c/51-tm_home_default.jpg" alt="Nacionales" />
                        </div>
                                                                            <div class="cat_desc  col-xs-12 col-sm-7 col-md-8 col-lg-9">
                            <span class="category-name">
                                Nacionales                            </span>
                                                            <div class="rte"><p>Estos son algunos de nuestros destinos nacionales:</p></div>
                                                        </div>
                                             </div>
                              </div>
				<h1 class="page-heading product-listing">
        	<span class="cat-name">Nacionales&nbsp;</span>
		...
		<div id="subcategories">
			...
			<ul class="clearfix">
                	...
                	<div class="subcategory-image">
						<a href="cdm.php" title="Ciudad de México" class="img">
															<img class="replace-2x" src="img/c/55-tm_medium_default.jpg" alt="Ciudad de México" />
													</a>
                   	</div>
					<h5>
                    	<a class="subcategory-name" href="cdm.php" title="Ciudad de México">Ciudad de México</a>
                    </h5>
									</li>
							<li>
                	<div class="subcategory-image">
						<a href="guadalajara.php" title="Guadalajara" class="img">
															<img class="replace-2x" src="img/c/56-tm_medium_default.jpg" alt="Guadalajara" />
													</a>
                   	</div>
					<h5>
                    	<a class="subcategory-name" href="guadalajara.php" title="Guadalajara">Guadalajara</a>
                    </h5>
									</li>
							<li>
                	<div class="subcategory-image">
						<a href="monterrey.php" title="Monterrey" class="img">
															<img class="replace-2x" src="img/c/57-tm_medium_default.jpg" alt="Monterrey" />
													</a>
                   	</div>
					<h5>
                    	<a class="subcategory-name" href="monterrey.php" title="Monterrey">Monterrey</a>
                    </h5>
									</li>
						</ul>
		</div>
        ...
        <li id="grid">
            <a rel="nofollow" href="index.php%3Fid_category=51&amp;controller=category.html#" title="Cuadr&iacute;cula">
                <i class="fa fa-th-large"></i>
                Cuadr&iacute;cula
            </a>
        </li>
        <li id="list">
            <a rel="nofollow" href="index.php%3Fid_category=51&amp;controller=category.html#" title="Lista">
     ...
     <form id="productsSortForm"  class="productsSortForm">
        <div class="select selector1">
            ...
            <select  class="selectProductSort form-control " onchange="sort(this.value)">
                <option value="nombre ASC" selected="selected">--</option>
                                    <option value="precio ASC" >Precio: m&aacute;s baratos primero</option>
                    <option value="precio DESC" >Precio: m&aacute;s caros primero</option>
                                <option value="nombre ASC" selected="selected">Nombre: de A a Z</option>
                <option value="nombre DESC" >Nombre: de Z a A</option>
                                    <option value="cantidad DESC" >En inventario primero</option>
    ...
    <!-- /Sort products -->
		...
		<!-- /nbr product/page -->
                ...
                <div class="top-pagination-content clearfix">
                		<form method="post" action="http://www.viajeomerida.com.mx/index.php?controller=products-comparison" class="compare-form">
...
$sql = "SELECT * FROM productos WHERE nacional = 'Nacional'";
...
<section class="blockcategories_footer footer-block col-xs-12 col-sm-2">
  ...
  Despreocúpate con nuestros paquetes todo incluido, aquí solo importa disfrutar.">
	...
	<a 	href="index.php%3Fid_category=51&amp;controller=category.html" class="selected" title="Estos son algunos de nuestros destinos nacionales:">
		Nacionales
	</a>
			<ul>
												<li >
	<a 	href="index.php%3Fid_category=55&amp;controller=category.html" title="">
		Ciudad de México
	</a>
	</li>
