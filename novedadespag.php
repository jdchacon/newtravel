...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>New products - Viajeo | Tu agencia de viajes</title>
...
function sort(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","novedadesajax.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
		...
		<body id="new-products" class="new-products hide-right-column lang_es  two-columns">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<span class="navigation_page">Novedades</span>
			</div>
...
<!-- /MODULE Block new products --><!-- Block Viewed products -->
<section id="viewed-products_block_left" class="block">
	...
	<div class="block_content products-block">
		<ul>
					...
					<a class="products-block-image" href="index.php%3Fid_product=54&amp;controller=product.html" title="Más acerca de Hotel Cozumel &amp;amp; Resort" >
						<img class="img-responsive" src="img/p/1/3/8/138-tm_small_default.jpg" alt="Hotel Cozumel &amp; Resort" />
					</a>
					<div class="product-content">
						<h5>
							<a class="product-name"	href="index.php%3Fid_product=54&amp;controller=product.html" title="Más acerca de Hotel Cozumel &amp;amp; Resort">
								Hotel Cozumel &amp; Resort
							</a>
						</h5>
						<p class="product-description">Desde: $ 2,299.00 mxn</p>
					</div>
				</li>
							<li class="clearfix last_item">
					<a class="products-block-image" href="index.php%3Fid_product=51&amp;controller=product.html" title="Más acerca de Ocean Riviera Paradise" >
						<img class="img-responsive" src="img/p/1/3/5/135-tm_small_default.jpg" alt="Ocean Riviera Paradise" />
					</a>
					<div class="product-content">
						<h5>
							<a class="product-name"	href="index.php%3Fid_product=51&amp;controller=product.html" title="Más acerca de Ocean Riviera Paradise">
								Ocean Riviera Paradise
							</a>
						</h5>
						<p class="product-description">Desde: $ 3,376.00 mxn
Período de...</p>
					</div>
				</li>
					</ul>
...
<h1 class="page-heading product-listing">Novedades</h1>
	...
	<div class="content_sortPagiBar">
        ...
        <li id="grid">
            <a rel="nofollow" href="index.php%3Fcontroller=new-products&amp;p=4.html#" title="Cuadr&iacute;cula">
                <i class="fa fa-th-large"></i>
                Cuadr&iacute;cula
            </a>
        </li>
        <li id="list">
            <a rel="nofollow" href="index.php%3Fcontroller=new-products&amp;p=4.html#" title="Lista">
...
$sqle = "SELECT COUNT(idproducto) AS hay FROM productos ";
...
?>   
	...
	<div id="pagination" class="pagination clearfix">
	    			<form class="showall" action="index.php%3Fcontroller=new-products.html" method="get">
				<div>
...
$sql = "SELECT * FROM productos LIMIT 9 OFFSET $off";
