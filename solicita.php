...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Solicita información - Viajeo | Tu agencia de viajes</title>
		...
		<link rel="shortcut icon" type="image/x-icon" href="img/favicon.ico%3F1493666561" />
			...
			<link rel="stylesheet" href="themes/theme1133/css/cms.css" media="all" />
...
var usingSecureMode = false;
			...
			<script type="text/javascript" src="themes/theme1133/js/cms.js"></script>
	...
	$(window).load(function(){
		...
		<body id="cms" class="cms cms-7 cms-solicita-informacion hide-left-column hide-right-column lang_es  one-column">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<span class="navigation_page">Solicita informaci&oacute;n</span>
			</div>
...
<!-- /Breadcrumb -->
			...
			<div class="rte">
		<p><iframe width="100%" height="500" src="reserva/Arma_tu_viaje.html">
</iframe></p>
	</div>
<br />
