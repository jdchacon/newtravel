...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Login - Viajeo | Tu agencia de viajes</title>
		...
		<link rel="shortcut icon" type="image/x-icon" href="img/favicon.ico%3F1493666561" />
			...
			<link rel="stylesheet" href="themes/theme1133/css/authentication.css" media="all" />
...
var usingSecureMode = false;
			...
			<script type="text/javascript" src="themes/theme1133/js/tools/vatManagement.js"></script>
			<script type="text/javascript" src="themes/theme1133/js/tools/statesManagement.js"></script>
			<script type="text/javascript" src="themes/theme1133/js/authentication.js"></script>
	...
	$(window).load(function(){
		...
		<body id="authentication" class="authentication hide-left-column hide-right-column lang_es  one-column">
	    	<!--[if IE 8]>
...
<h1 class="page-heading">Autenticaci&oacute;n</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="index.php%3Fcontroller=authentication.html" method="post" id="create-account_form" class="box">
...
$sql = "SELECT idusuario, correo, pass FROM usuarios";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "id: " . $row["idusuario"]. " - Name: " . $row["correo"]. " " . $row["pass"]. "<br>";
    }
} else {
    echo "0 results";
}
...
?>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="index.php%3Fcontroller=authentication.html" method="post" id="login_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<p class="lost_password form-group">
                    	<a href="index.php%3Fcontroller=password.html" title="Recuperar la contrase&ntilde;a" rel="nofollow">&iquest;Olvidaste tu contrase&ntilde;a?</a>
                    </p>
					<p class="submit">
