...
function sort(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","miamiajax.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<a href="index.php%3Fid_category=53&amp;controller=category.html" title="Destinos" data-gg="">Destinos</a><span class="navigation-pipe">></span><a href="index.php%3Fid_category=52&amp;controller=category.html" title="Internacionales" data-gg="">Internacionales</a><span class="navigation-pipe">></span>Miami
			</div>
...
<!-- /MODULE Block new products --></div>
                    ...
                    <div class="content_scene_cat_bg row">
                        	...
                        	<img class="img-responsive" src="img/c/45-tm_home_default.jpg" alt="Miami" />
                        </div>
                                                                     </div>
                              </div>
				<h1 class="page-heading product-listing">
        	<span class="cat-name">Miami&nbsp;</span>
...
$sql = "SELECT * FROM productos WHERE ciudad = 'Miami'";
