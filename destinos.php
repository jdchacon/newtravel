...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>Destinos - Viajeo | Tu agencia de viajes</title>
...
var usingSecureMode = false;
	...
	$(window).load(function(){
		...
		<body id="category" class="category category-53 category-destinos hide-right-column lang_es  two-columns">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<span class="navigation_page">Destinos</span>
			</div>
...
<section id="categories_block_left" class="block">
	...
	<div class="block_content">
		<ul class="tree dhtml">
												<li >
	<a 	href="dnacional.php" title="Estos son algunos de nuestros destinos nacionales:">
		Nacionales
	</a>
			<ul>
												<li >
	...
	<a 	href="monterrey.php" title="">
		Monterrey
																...
																<li >
	<a 	href="dinternacional.php" title="Estos son algunos de nuestros destinos internacionales">
		Internacionales
	</a>
			<ul>
												<li >
...
<!-- /MODULE Block new products --></div>
                    ...
                    <div class="content_scene_cat_bg row">
                        	...
                        	<img class="img-responsive" src="img/c/53-tm_home_default.jpg" alt="Destinos" />
                        </div>
                                                                     </div>
                              </div>
				<h1 class="page-heading product-listing">
        	<span class="cat-name">Destinos&nbsp;</span>
		...
		<div id="subcategories">
			...
			<ul class="clearfix">
                	...
                	<div class="subcategory-image">
						<a href="dnacional.php" title="Nacionales" class="img">
															<img class="replace-2x" src="img/c/51-tm_medium_default.jpg" alt="Nacionales" />
													</a>
                   	</div>
					<h5>
                    	<a class="subcategory-name" href="dnacional.php" title="Nacionales">Nacionales</a>
                    </h5>
											<div class="cat_desc"><p>Estos son algunos de nuestros destinos nacionales:</p></div>
									</li>
							<li>
                	<div class="subcategory-image">
						<a href="dinternacional.php" title="Internacionales" class="img">
															<img class="replace-2x" src="img/c/52-tm_medium_default.jpg" alt="Internacionales" />
													</a>
                   	</div>
					<h5>
                    	<a class="subcategory-name" href="dinternacional.php" title="Internacionales">Internacionales</a>
                    </h5>
											<div class="cat_desc"><p>Estos son algunos de nuestros destinos internacionales</p></div>
									</li>
						</ul>
		</div>
...
<section class="blockcategories_footer footer-block col-xs-12 col-sm-2">
  ...
  Despreocúpate con nuestros paquetes todo incluido, aquí solo importa disfrutar.">
	...
	<a 	href="index.php%3Fid_category=53&amp;controller=category.html" class="selected" title="">
		Destinos
	</a>
			<ul>
												<li >
