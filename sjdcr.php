...
<html lang="es">
	<head>
		<meta charset="utf-8" />
		<title>San José de Costa Rica - Viajeo | Tu agencia de viajes</title>
...
function sort(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","sjdcrajax.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
	...
	$(window).load(function(){
		...
		<body id="category" class="category category-49 category-san-jose-de-costa-rica hide-right-column lang_es  two-columns">
	    	<!--[if IE 8]>
	...
	<a class="home" href="index.html" title="Volver a Inicio">
    	<i class="fa fa-home"></i>
			...
			<span class="navigation-pipe" >&gt;</span>
					<a href="index.php%3Fid_category=53&amp;controller=category.html" title="Destinos" data-gg="">Destinos</a><span class="navigation-pipe">></span><a href="index.php%3Fid_category=52&amp;controller=category.html" title="Internacionales" data-gg="">Internacionales</a><span class="navigation-pipe">></span>San Jos&eacute; de Costa Rica
			</div>
...
<!-- /MODULE Block new products --></div>
                    ...
                    <div class="content_scene_cat_bg row">
                        	...
                        	<img class="img-responsive" src="img/c/49-tm_home_default.jpg" alt="San José de Costa Rica" />
                        </div>
                                                                     </div>
                              </div>
				<h1 class="page-heading product-listing">
        	<span class="cat-name">San José de Costa Rica&nbsp;</span>
...
$sqle = "SELECT COUNT(idproducto) AS hay FROM productos WHERE ciudad = 'San Jose de Costa Rica'";
...
?></span>
        ...
        <li id="grid">
            <a rel="nofollow" href="index.php%3Fid_category=49&amp;controller=category.html#" title="Cuadr&iacute;cula">
                <i class="fa fa-th-large"></i>
                Cuadr&iacute;cula
            </a>
        </li>
        <li id="list">
            <a rel="nofollow" href="index.php%3Fid_category=49&amp;controller=category.html#" title="Lista">
...
$sql = "SELECT * FROM productos WHERE ciudad = 'San Jose de Costa Rica'";
...
<section class="blockcategories_footer footer-block col-xs-12 col-sm-2">
  ...
  Despreocúpate con nuestros paquetes todo incluido, aquí solo importa disfrutar.">
	...
	<a 	href="index.php%3Fid_category=49&amp;controller=category.html" class="selected" title="">
